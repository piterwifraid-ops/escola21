          ...
          <div className="mt-6">
            <div className="mb-3">
              ...
              <ul className="flex space-x-2">
                <li>
                  <a href="https://x.com/mintrabalhobr" aria-label="X" className="flex items-center justify-center w-8 h-8 bg-opacity-20 bg-white rounded-full" target="_blank" rel="noopener noreferrer">
                ...
                <li>
                  <a href="https://www.facebook.com/trabalhoeemprego/" aria-label="Facebook" className="flex items-center justify-center w-8 h-8 bg-opacity-20 bg-white rounded-full" target="_blank" rel="noopener noreferrer">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                  <a href="https://www.youtube.com/c/canaltrabalho" aria-label="YouTube" className="flex items-center justify-center w-8 h-8 bg-opacity-20 bg-white rounded-full" target="_blank" rel="noopener noreferrer">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                  <a href="https://br.linkedin.com/company/minist-rio-do-trabalho-e-emprego" aria-label="LinkedIn" className="flex items-center justify-center w-8 h-8 bg-opacity-20 bg-white rounded-full" target="_blank" rel="noopener noreferrer">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-4">
              <a href="https://www.gov.br/acessoainformacao/pt-br" title="Acesse o portal sobre o acesso à informação" target="_blank" rel="noopener noreferrer">
