				...
				<div className="bg-white rounded-lg p-6 md:p-8 shadow-sm">
					...
					<div className="flex gap-3 mt-6 w-full">
						<button
							...
							className="flex-1 max-w-[180px] flex items-center justify-center gap-2 px-4 py-2 md:px-6 md:py-3 rounded-lg text-[#1351B4] bg-white border border-[#1351B4] font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-all"
							style={{ minWidth: 0 }}
						>
							<ArrowLeft size={18} />
							<span>Anterior</span>
						...
						<button
							...
							className="flex-1 flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm md:text-base font-medium transition-colors h-12 md:h-14 pl-4 pr-2 bg-[#1351B4] hover:bg-[#0C3D99] text-white disabled:opacity-50 disabled:cursor-not-allowed border-0 shadow-none"
							style={{ minWidth: 0, maxWidth: '100%' }}
						>
							<span>{isLastQuestion ? "Finalizar" : "Próxima Pergunta"}</span>
							<ArrowRight size={18} />
						</button>
					</div>
				</div>
